...
export default function CommunionCyclesCreate() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('communions.cycles.store'));
    };

    return (
        <AuthenticatedLayout>
            <Head title="Create Communion Cycle" />

            <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create Communion Cycle</h1>
                ...
                <form onSubmit={submit} className="space-y-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Communion 2026"
                        />
