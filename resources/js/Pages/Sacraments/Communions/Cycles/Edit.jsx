...
export default function CommunionCyclesEdit({ cycle }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('communions.cycles.update', cycle.uuid), { preserveScroll: true });
    };

    return (
        <AuthenticatedLayout>
            <Head title="Edit Communion Cycle" />

            <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Edit Communion Cycle</h1>
                ...
                <form onSubmit={submit} className="space-y-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                        <SecondaryButton type="button" className="h-11" onClick={() => router.get(route('communions.cycles.index'))}>
                            Back
                        </SecondaryButton>
