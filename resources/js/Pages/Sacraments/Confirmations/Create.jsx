...
export default function ConfirmationsCreate({ cycles, default_cycle_uuid }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Create Confirmation Registration" />

            <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create Confirmation Registration</h1>
                ...
                <form onSubmit={submit} className="space-y-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                        Candidate must have completed First Communion before registration.
                    </div>
