...
use App\Policies\ParishAssociationLeadershipPolicy;
use App\Policies\ParishAssociationMemberPolicy;
use App\Policies\ParishAssociationPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ParishAssociation::class, ParishAssociationPolicy::class);
        Gate::policy(ParishAssociationMember::class, ParishAssociationMemberPolicy::class);
        Gate::policy(ParishAssociationLeadership::class, ParishAssociationLeadershipPolicy::class);
