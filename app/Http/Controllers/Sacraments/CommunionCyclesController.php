...
class CommunionCyclesController extends Controller
{
    ...
    private function resolveParishId(?\App\Models\User $user): int
    {
        ...
        $single = (int) (DB::table('parishes')->orderBy('id')->value('id') ?? 0);
        return $single;
    }
    ...
    {
        $user = $request->user();
        if (! $user || ! $user->can('communions.cycles.manage')) {
            abort(403);
        }
        ...
        return Inertia::render('Sacraments/Communions/Cycles/Index', [
            'cycles' => $cycles,
        ]);
    }
    ...
    public function create(Request $request): Response
    {
        ...
        return Inertia::render('Sacraments/Communions/Cycles/Create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('communions.cycles.index')->with('success', 'Cycle created.');
    }
    ...
    public function edit(Request $request, SacramentProgramCycle $cycle): Response
    {
        ...
        if (($cycle->program ?? null) !== SacramentProgramCycle::PROGRAM_FIRST_COMMUNION) {
            abort(404);
        }
        ...
        return Inertia::render('Sacraments/Communions/Cycles/Edit', [
            'cycle' => $cycle,
        ]);
    }
