...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'members.delete',
            'members.transfer',
            'parish-associations.view',
            'parish-associations.view-all',
            'parish-associations.members.view',
            'parish-associations.leadership.view',
            'parish-associations.leader-roles.view',
            'parish-associations.create',
            'parish-associations.update',
            'parish-associations.delete',
